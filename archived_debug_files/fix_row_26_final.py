#!/usr/bin/env python3
"""Fix row 26 specifically using TradeTracker methods"""
...
def fix_row_26():
    """Fix the SOFI Sold Put in row 26 using TradeTracker methods"""
    ...
    try:
        ...
        if "put" in trade_type:
            ...
            try:
                option_price = app.get_option_price_from_etrade(ticker, strike, "put", expiry_str)
                if option_price:
