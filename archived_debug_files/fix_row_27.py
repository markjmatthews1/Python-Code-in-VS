#!/usr/bin/env python3
"""Fix row 27 specifically using direct E*TRADE calls"""
...
def fix_row_27():
    """Fix the SOFI Sold Put in row 27"""
    excel_filename = "Bryan Perry Transactions.xlsx"
    sheet_name = "Open_Trades_2025"
    
    print("Checking and fixing row 27 (SOFI Sold Put)...")
            ...
            try:
                ...
                if option_price:
                    ...
                    if cost and shares:
                        ...
                        print(f"✅ Row 27 updated and saved to Excel!")
                    else:
