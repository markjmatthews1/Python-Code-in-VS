...
# This script is used to authenticate with the Charles Schwab API using OAuth2.
# It constructs the initial authorization URL, opens it in a web browser, and retrieves the authorization code.
...
def construct_init_auth_url() -> tuple[str, str, str]:
    ...
    auth_url = f"https://api.schwabapi.com/v1/oauth/authorize?client_id={app_key}&redirect_uri=https://127.0.0.1:5000/callback"
