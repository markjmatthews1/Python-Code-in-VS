...
class LiveDashboardPanel:
    ...
    def _create_control_panel(self):
        ...
        # Update frequency
        ttk.Label(control_frame, text="Update Frequency:").pack(side=tk.LEFT, padx=(10, 5))
    ...
    def _create_live_scores_tab(self):
        ...
        self.total_tickers_label = tk.Label(stats_row, text="Total Tickers: 0", font=('Arial', 11))
        self.total_tickers_label.pack(side='left', padx=(0, 20))
        
        self.avg_score_label = tk.Label(stats_row, text="Avg Score: 0.0", font=('Arial', 11))
        self.avg_score_label.pack(side='left', padx=(0, 20))
        
        self.high_alerts_label = tk.Label(stats_row, text="High Alerts: 0", font=('Arial', 11))
        self.high_alerts_label.pack(side='left', padx=(0, 20))
        
        self.last_update_label = tk.Label(stats_row, text="Last Update: Never", font=('Arial', 10))
    ...
    def _create_status_bar(self):
        ...
        self.data_status = ttk.Label(status_frame, text="📡 Data: Offline", foreground="red")
        self.data_status.pack(side=tk.RIGHT, padx=(0, 10))
        
        self.portfolio_status = ttk.Label(status_frame, text="💼 Portfolio: Not Loaded", foreground="red")
